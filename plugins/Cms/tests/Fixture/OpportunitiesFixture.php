...
class OpportunitiesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'excerpt' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'local' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2015-06-29 19:24:28',
            'modified' => '2015-06-29 19:24:28'
        ],
    ];
}
